        ...
        feedbackForm.addEventListener('submit', async (e) => {
            ...
            try {
                ...
                if (window.location.port === '5500') {
                    alert('Developer Tip: You are running on port 5500 (Live Server). For the feedback form to work locally, please run "node server.js" and visit http://127.0.0.1:3000');
                } else {
